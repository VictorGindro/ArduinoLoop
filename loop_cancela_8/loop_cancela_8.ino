...
int checkSubiu(){
  ...
  cancela[7] = {24, 25, 50, 51, 52};
  int arrSize = sizeof(cancela)/sizeof(cancela[0]);
  if(digitalRead(cancela[0].subiu) == false && digitalRead(cancela[1].subiu) == false && digitalRead(cancela[2].subiu) == false && digitalRead(cancela[3].subiu) == false && cancela[4].subiu == false && cancela[5].subiu == false && cancela[6].subiu == false && cancela[7].subiu == false){
...
int checkDesceu(){
  ...
  cancela[7] = {24, 25, 50, 51, 52};
  int arrSize = sizeof(cancela)/sizeof(cancela[0]);
  if(digitalRead(cancela[0].desceu) == false && digitalRead(cancela[1].desceu) == false && digitalRead(cancela[2].desceu) == false && digitalRead(cancela[3].desceu) == false  && cancela[4].desceu == false && cancela[5].desceu == false && cancela[6].desceu == false && cancela[7].desceu == false){
